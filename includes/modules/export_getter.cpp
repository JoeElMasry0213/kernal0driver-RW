...
uint8_t* IDontLikeBlue::find_export( const uint64_t module_addr, const char* export_name )
{
	if ( !module_addr )
		return nullptr;
...
uint8_t* IDontLikeBlue::find_export( const char* module_name, const char* export_name )
{
